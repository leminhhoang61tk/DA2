    ...
    useEffect(() => {
        ...
        const fetchWarehouseData = async () => {
            try {
                ...
                console.trace("Tổng số kho:", warehouseCount);
                console.trace("Tổng số sản phẩm:", productCount);
                console.trace("Sản phẩm sắp hết:", lowStockCount);
                console.trace("Sản phẩm hết hàng:", outOfStockCount);
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-9" style={{ whiteSpace: "nowrap" }}>
                                        ...
                                        <div className="text-muted">Tổng số kho hàng</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-9" style={{ whiteSpace: "nowrap" }}>
                                        ...
                                        <div className="text-muted">Sắp hết hàng</div>
                                    </div>
                                </div>
                            </div>
                        </div>
