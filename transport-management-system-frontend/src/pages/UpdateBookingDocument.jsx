...
const UpdateBookingDocument = () => {
  ...
  const updateBookingDocument = (e) => {
    e.preventDefault();

    const formData = new FormData();
    formData.append("id", booking.id);
    formData.append("document", selectedImage1);

    axios
      .put(
        "http://localhost:8080/api/transport/client/booking/document/udpate",
        formData,
        {
          headers: {
      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center">
        ...
        >
          <div className="card-body text-color">
            <h3 className="card-title text-center">Update Booking Document</h3>
